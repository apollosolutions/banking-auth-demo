...
export const startSubgraphs = async (httpPort) => {
  ...
  for (const subgraph of LOCAL_SUBGRAPH_CONFIG) {
    ...
    const server = new ApolloServer({
      ...
      introspection: true,
      // Only include stacktraces in development mode to avoid exposing internals
      includeStacktraceInErrorResponses: process.env.NODE_ENV === 'dev',
      plugins: [
